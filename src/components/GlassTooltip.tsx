...
const GlassTooltip = ({ label, children }: GlassTooltipProps) => (
  <div className="relative group flex items-center shrink-0">
    {children}
    <div className="absolute bottom-full mb-2 left-0 whitespace-nowrap pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-150 z-50">
